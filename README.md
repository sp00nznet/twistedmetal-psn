...
| **Bug 6**: MDEC returns a pattern | ⬜ **Bounded to four functions** — `func_000E9A18`/`EA2F0`/`EA44C`/`EAA88`, running, verified-correct input, verified-correct output path; blocks the FMV picture **and** attract mode |
