...
| **Bug 6**: a Huffman decode loop never terminates | ⬜ PS1 code at `0x80164F80`, table at `0x8017E47C` **intact** with both terminators present — so the bitstream or the bit-field extraction is at fault; blocks the FMV picture **and** attract mode |
