...
| **Bug 6**: MDEC returns a pattern | ⬜ **Localised to `func_000E9A18` (write) / `func_000EA2F0` (read)** — input verified correct, every stage downstream verified correct; blocks the FMV picture **and** attract mode |
